...
resource "vsphere_virtual_machine" "cloned_virtual_machine_04" {
  name             = "TF_${var.vm_name_04}"
  #name             = "TFDL01"
  ...
  clone {
    ...
    customize {
      linux_options {
        #host_name = "TF_${var.vm_name_04}"
        #host_name = "TF-Downloader01"
        host_name = var.vm_name_04
        domain    = var.network_domain
      }
      network_interface {
        ipv4_address = var.vm_ip_04
